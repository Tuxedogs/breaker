    ...
    <section className="subtarget-modern turret-modern additional-modern route-fade pb-8 pt-2">
      <div className="mx-auto max-w-[1180px] space-y-4">
        ...
        <article className="base-card base-card--systems additional-panel p-4 sm:p-5">
          <div className="base-card-head additional-panel-head subtarget-video-shell p-4 sm:p-5">
        ...
        <article className="base-card base-card--systems additional-panel p-4 sm:p-5">
          <section className="subtarget-practice-layout space-y-4">
            <article className="base-card-head additional-panel-head subtarget-practice-card p-4 sm:p-5">
            ...
            <aside className="base-card-head additional-panel-head subtarget-reference-card p-4 sm:p-5">
        ...
        <article className="base-card base-card--systems additional-panel p-4 sm:p-5">
          <div className="grid gap-4 md:grid-cols-2">
            <section className="base-card-head additional-panel-head p-4 sm:p-5">
