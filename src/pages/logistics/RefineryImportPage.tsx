            ...
            wo.rows
              ...
              .map((r) => {
                ...
                return createInventoryEntryDraft({
                  ...
                  qualityBand: r.editedQuality === r.quality ? r.qualityBand : undefined,
                  locationId,
...
function CroppedPanelImage({
  ...
  const sw = region?.sw;
  const sh = region?.sh;
  const hasRegion = sx != null && sy != null && sw != null && sh != null;
